{ =================================================================================
  ...
  ----------------------------------------------------------------------------------
  File   : l17dom.pas
  Module : List & Label 17 DOM
  Descr. : Implementation file for the List & Label 17 DOM
  Version: 17.001
  ==================================================================================
}
...
uses
  Classes, l17, cmbtll17, Dialogs, SysUtils, l17db, graphics, Windows;
...
type
  ...
  TLlDOMChartType = (ctBar2D, ctBar2DClustered, ctBar2DStacked,
  ...
  public
    ...
    function CreateSubObject(index: integer;
  ...
  public
    ...
    property ProjectParameterList: TLlDOMPropertyProjectParameterList read
    ...
    property ProjectTemplates: TLlDOMProjectTemplateList read
    ...
    constructor Create(hTheParentComponent: TL17_);
    ...
    function Open(projectFile: TString; fileMode: TLlDOMFileMode): integer;
      overload;
  ...
  public
    ...
    constructor Create(hTheParentComponent: TL17_); overload;
  end;
  ...
  public
    procedure DeleteSubobject(index: integer);
  end;
  ...
  public
    property Items[index: integer]
      : TLlDOMProjectTemplate read GetItems write SetItems; default;
  ...
  public
    property Items[index: integer]: TLlDOMLayer read GetItems write SetItems;
    default;
  ...
  TLlDOMDrillDownLink = class(TLlDOMItem)
  private
  ...
  public
    ...
    property ParentKeyField: TString read GetParentKeyField write
      SetParentKeyField;
    property ParentTableID
      : TString read GetParentTableID write SetParentTableID;
    property ProjectFileName: TString read GetProjectFileName write
      SetProjectFileName;
    property RelationID: TString read GetRelationID write SetRelationID;
    property ChildKeyField
      : TString read GetChildKeyField write SetChildKeyField;
    property ChildTableID: TString read GetChildTableID write SetChildTableID;
    constructor Create(list: TLlDOMDrillDownLinkList); overload;
  end;

  TLlDOMDrillDownLinkList = class(TLlDOMList)
  private
    function GetItems(index: integer): TLlDOMDrillDownLink;
    procedure SetItems(index: integer; const value: TLlDOMDrillDownLink);
    function Add(domObj: TLlDOMDrillDownLink): integer;
  public
    property Items[index: integer]
      : TLlDOMDrillDownLink read GetItems write SetItems; default;
  ...
  public
    ...
    property ForcePaperFormat: TString read GetForcePaperFormat write
      SetForcePaperFormat;
    property Name: TString read GetName write SetName;
    property SourceTray: TString read GetSourceTray write SetSourceTray;
    property UsePhysicalPaper: TString read GetUsePhysicalPaper write
      SetUsePhysicalPaper;
    property ShowInPrintDialog: TString read GetShowInPrintDialog write
      SetShowInPrintDialog;
...
{$ELSE} DevMode: PDeviceModeA {$ENDIF}; DeviceName: string); overload;
  ...
  public
    property Items[index: integer]: TLlDOMRegion read GetItems write SetItems;
    default;
  ...
  public
    ...
    property ParameterType
      : TString read GetParameterType write SetParameterType;
  ...
  public
    property Items[Index: integer]
      : TLlDOMPropertyProjectParameterBase read GetItems write SetItems;
    property ItemName[Name: TString]
      : TLlDOMPropertyProjectParameterBase read GetItemName write
      SetItemName;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
    function NewItem(index: integer): TLlDOMItem;
  ...
  private
    ...
    function GetVisual: TString;
    procedure SetVisual(const value: TString);
    function GetWidth: TString;
    procedure SetWidth(const value: TString);

  public
    property Color: TString read GetColor write SetColor;
    property CoordinateLabel: TString read GetCoordinateLabel write
      SetCoordinateLabel;
    ...
    property ValueAxisAssignment: TString read GetValueAxisAssignment write
      SetValueAxisAssignment;
    property Visual: TString read GetVisual write SetVisual;
  ...
  public
    property Items[index: integer]
      : TLlDOMChartRow read GetItems write SetItems; default;
  ...
  public
    property Items[Index: integer]
      : TLlDOMUserVariable read GetItems write SetItems; default;
  ...
  public
    property ForcePaperFormat: TString read GetForcePaperFormat write
      SetForcePaperFormat;
    property UsePhysicalPage: TString read GetUsePhysicalPage write
      SetUsePhysicalPage;
  end;
  ...
  public
    property CatchRangePixels: TString read GetCatchRangePixels write
      SetCatchRangePixels;
  ...
  public
    property Items[Index: integer]
      : TLlDOMRulerGuide read GetItems write SetItems; default;
  ...
  public
    ...
    property TableOfContents
      : TLlDOMPropertyReportSection read GetTableOfContents;
    destructor Destroy; override;
  end;
  ...
  public
    ...
    property DefaultDefaultFont
      : TLlDOMPropertyDefaultFont read GetDefaultDefaultFont;
    property RepresentationCodes: TLlDOMPropertyRepresentationCodes read
      GetRepresentationCodes;
    property TextQuoteCodes
      : TLlDOMPropertyTextQuoteCodes read GetTextQuoteCodes;
    property Created: TString read GetCreated write SetCreated;
    property Decimals: TString read GetDecimals write SetDecimals;
    property DefaultDestination: TString read GetDefaultDestination write
      SetDefaultDestination;
    property FileVersion: TString read GetFileVersion write SetFileVersion;
    property LCID: TString read GetLCID;
    property MaxPDFOutlineDepth: TString read GetMaxPDFOutlineDepth write
      SetMaxPDFOutlineDepth;
    property MaxPDFIndexDepth: TString read GetMaxPDFIndexDepth write
      SetMaxPDFIndexDepth;
  ...
  public
    property Count: TString read GetCount write SetCount;
    property ColumnBreakBefore: TString read GetColumnBreakBefore write
      SetColumnBreakBefore;
    property ColumnBreakCondition: TString read GetColumnBreakCondition write
      SetColumnBreakCondition;
    property Distance: TString read GetDistance write SetDistance;
  end;
  ...
  public
    property AlignmentType
      : TString read GetAlignmentType write SetAlignmentType;
    property DecimalPosition: TString read GetDecimalPosition write
      SetDecimalPosition;
  end;
  ...
  public
    ...
    property ValidationFailedHint: TString read GetValidationFailedHint write
      SetValidationFailedHint;
  end;
  ...
  public
    property FileName: TString read GetFileName write SetFileName;
    property FileNameIsRelative: TString read GetFileNameIsRelative write
      SetFileNameIsRelative;
  end;
  ...
  TLlDOMPropertyAction = class(TLlDOMItem)
  private
    function GetFormat: TString;
    procedure SetFormat(const value: TString);
  ...
  private
    ...
    procedure SetShow(const value: TString);
  public
    property BeforeEntries
      : TString read GetBeforeEntries write SetBeforeEntries;
    property Show: TString read GetShow write SetShow;
  end;
  ...
  public
    property AlignmentHorizontal: TLlDOMPropertyAlignmentHorizontal read
      GetAlignmentHorizontal;
    property AlignmentVertical: TString read GetAlignmentVertical write
    ...
    property OutputFormatter: TLlDOMPropertyOutputFormatterBase read
      GetOutputFormatterBase;
  ...
  private
    ...
    function GetSortOrderAscending: TString;
    procedure SetSortOrderAscending(const value: TString);
  public
    property ShowSpanLabel
      : TString read GetShowSpanLabel write SetShowSpanLabel;
    property SortOrderAscending: TString read GetSortOrderAscending write
  ...
  public
    ...
    property GroupLabel
      : TLlDOMCrosstabCellGroupLabelList read GetGroupLabelList;
  ...
  public
    ...
    property ColumnWrapping: TLlDOMPropertyCrosstabColumnWrapping read
      GetColumnWrapping;
    ...
    property LinkURL: TString read GetLinkURL write SetLinkURL;
    property MinHeight: TString read GetMinHeight write SetMinHeight;
    property WrapPercentage: TString read GetWrapPercentage write
      SetWrapPercentage;
  ...
  public
    ...
    property ConditionalColors: TLlDOMChartConditionalColorsList read
      GetConditionalColors;
    property Title: TLlDOMPropertyChartTitle read GetTitle;
    property TitlePosition
      : TString read GetTitlePosition write SetTitlePosition;
    property Bookmark: TLlDOMPropertyBookmark read GetBookmark;
  ...
  public
    property value: TString read GetValue write SetValue;
    property ScalePercentageMinimum
      : TString read GetWhiteSpaceBeforeScaleRange
      write SetWhiteSpaceBeforeScaleRange;
    property ScalePercentageMaximum
      : TString read GetWhiteSpaceAfterScaleRange
      write SetWhiteSpaceAfterScaleRange;
    property Frame: TLlDOMPropertyAlphaBlendableItem read
      GetPropertyAlphaBlendableItemFrame;
    property Glass: TLlDOMPropertyAlphaBlendableItem read
      GetPropertyAlphaBlendableItemGlass;
    property Pointer: TLlDOMPropertyPointer read GetPropertyPointer;
    property MinimumValue: TLlDOMPropertyScaleLimits read
      GetPropertyMinimumValue;
    property MaximumValue: TLlDOMPropertyScaleLimits read
    ...
    property ScaleRangeRotationAngle
      : TString read GetScaleRangeRotationAngle write
      SetScaleRangeRotationAngle;
    property Style: TString read GetStyle write SetStyle;
    property WidthHeightRelation: TString read GetWidthHeightRelation write
      SetWidthHeightRelation;
    destructor Destroy; override;
  end;
  ...
  public
    ...
    property FillingFinished
      : TLlDOMPropertyChartFilling read GetFinishedFilling;
    property HeightFinished: TString read GetHeightFinished write
      SetHeightFinished;
    property HeightUnfinished: TString read GetHeightUnfinished write
      SetHeightUnfinished;
    property Rounding: TString read GetRounding write SetRounding;
    property FillingUnfinished
      : TLlDOMPropertyChartFilling read GetUnfinishedFilling;
    destructor Destroy; override;
  end;
  ...
  public
    ...
    property OutputFormatter
      : TLlDOMPropertyOutputFormatterBase read GetOuputFormatter;
  ...
  public
    ...
    property PercentageCompleteCell
      : TLlDOMPropertyCell read GetPercentageCompleteCell;
  ...
  public
    ...
    property AssumeDayResolution: TString read GetAssumeDayResolution write
      SetAssumeDayResolution;
    ...
    property HighlightRange
      : TLlDOMPropertyHighlightRange read GetHighlightRange;
    property LinkURL: TString read GetLinkURL write SetLinkURL;
    property MinHeight: TString read GetMinHeight write SetMinHeight;
    property PercentageComplete: TString read GetPercentageComplete write
      SetPercentageComplete;
    property StartDate: TString read GetStartDate write SetStartDate;
    property SummaryTaskDescription
      : TString read GetSummaryTaskDescription write
      SetSummaryTaskDescription;
    property SummaryTaskRows: TLlDOMPropertyTaskRows read GetSummaryTaskRows;
    property TaskDescription: TString read GetTaskDescription write
      SetTaskDescription;
  ...
  public
    ...
    property Items[index: integer]
      : TLlDOMColorRangeItem read GetItems write SetItems;
    function NewItem(index: integer): TLlDOMItem;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
  end;
  ...
  public
    property Automatic: TString read GetAutomatic write SetAutomatic;
    property AbsoluteValues: TString read GetAbsoluteValues write
      SetAbsoluteValues;
    property AutomaticFilling
      : TLlDOMPropertyChartFilling read GetAutomaticFilling;
  ...
  public
    ...
    property Items[index: integer]
      : TLlDOMIconRangeItem read GetItems write SetItems;
    function NewItem(index: integer): TLlDOMItem;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
  end;
  ...
  public
    property value: TString read GetValue write SetValue;
    property FitToDistance
      : TString read GetFitToDistance write SetFitToDistance;
  End;
  ...
  public
    ...
    property SizeAdjustment: TString read GetSizeAdjustment write
      SetSizeAdjustment;
    property Alignment: TString read GetAlignment write SetAlignment;
  ...
  public
    ...
    property SubTickPosition: TString read GetSubTickPosition write
      SetSubTickPosition;
  ...
  public
    ...
    property Items[index: integer]
      : TLlDOMPropertySignalItem read GetItems write SetItems;
    function NewItem(index: integer): TLlDOMItem;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
  end;
  ...
  public
    ...
    property Items[index: integer]
      : TLlDOMPropertyTextItem read GetItems write SetItems;
    function NewItem(index: integer): TLlDOMItem;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
  end;
  ...
  public
    property ElevatedBorder: TString read GetElevatedBorder write
      SetElevatedBorder;
  ...
  public
    property AggregateType
      : TString read GetAggregateType write SetAggregateType;
    property CoordinateLabelOnObject:
      TLlDOMPropertyChartLabelCoordinateOnObjectPie read
      GetCoordinateLabelOnObject;
    property ExplosionPercentage: TString read GetExplosionPercentage write
      SetExplosionPercentage;
    property value: TString read GetValue write SetValue;
    property Width: TString read GetWidth write SetWidth;
  ...
  public
    property ValueAxisPie3D[index: integer]
      : TLlDOMPropertyValueAxisPie3D read GetValueAxisPie3D; default;

    destructor Destroy; override;
  end;

  TLlDOMPropertyValueAxisBase = class(TLlDOMItem)
  private
    ...
    procedure SetValue(const value: TString);
  public
    property BubbleChartMode: TString read GetBubbleChartMode write
      SetBubbleChartMode;
    property CoordinateLabel: TLlDOMPropertyChartLabelCoordinate read
      GetCoordinateLabel;
    property CoordinateLabelOnObject
      : TLlDOMPropertyChartLabelCoordinateOnObject
      read GetCoordinateLabelOnObject;
    property CoordinateLabelPlacement
      : TLlDOMPropertyCoordinateLabelPlacement
    ...
    property IntermediateTickCount: TString read GetIntermediateTickCount write
      SetIntermediateTickCount;
    property ZebraPattern: TLlDOMPropertyFilling read GetZebraPattern;
    property GetSignalRanges
      : TLlDOMPropertyGetSignalRanges read GetGetSignalRanges;
    property TickmarkColor
      : TString read GetTickmarkColor write SetTickmarkColor;
    property value: TString read GetValue write SetValue;
  ...
  public
    property ValueAxis[index: integer]
      : TLlDOMPropertyValueAxisBase read GetValueAxis; default;
  ...
  public
    property ValueAxisPie2D[index: integer]
      : TLlDOMPropertyValueAxisPie2D read GetValueAxisPie2D; default;
  ...
  public
    ...
    property EnhancedColorContrast: TString read GetEnhancedColorContrast write
      SetEnhancedColorContrast;
    destructor Destroy; override;
  end;
  ...
  public
    ...
    property FixedFontSize
      : TString read GetFixedFontSize write SetFixedFontSize;
    property Font: TLlDOMPropertyFont read GetFont;
    property OutputFormatter: TLlDOMPropertyOutputFormatterBase read
      GetOutputFormatter;
  ...
  TLlDOMPropertyCategoryAxis = class(TLlDOMItem)
  private
    fCoordinateLabel: TLlDOMPropertyChartLabelCoordinate;
  ...
  public
    ...
    property AxisLabel: TLlDOMPropertyChartLabel read GetAxisLabel;
    property Filter: TString read GetFilter write SetFilter;
    property SamplesForDesigner: TString read GetSamplesForDesigner write
      SetSamplesForDesigner;
  ...
  public
    property CoordinateLabelOthers
      : TLlDOMPropertyChartLabelCoordinateOthers
      read GetCoordinateLabelOthers;
    property CoordinateLabelPlacement
      : TLlDOMPropertyCoordinateLabelPlacement
      read GetCoordinateLabelPlacement;
    property CoordinateLabelPie: TLlDOMPropertyChartLabelPie read
      GetCoordinateLabelPie;
    property MinimumPercentage: TString read GetMinimumPercentage write
  ...
  public
    ...
    property ShowSeparatorLines: TString read GetShowSeparatorLines write
      SetShowSeparatorLines;
    ...
    property YAxis: TLlDOMPropertyValueAxisPie2DArray read
      GetValueAxisPie2DArray;
  ...
  public
    ...
    property XRotation: TString read GetXRotation write SetXRotation;
    property XAxis: TLlDOMPropertyCategoryAxisPie read GetCategoryAxisPie;
    property YAxis: TLlDOMPropertyValueAxisPie3DArray read
      GetValueAxisPie3DArray;
    property ZRotation: TString read GetZRotation write SetZRotation;
  ...
  public
    ...
    property SecondaryValueAxis: TLlDOMPropertyChartSecondaryValueAxis read
      GetSecondaryValueAxis;
    property UseLightEffect: TString read GetUseLightEffect write
      SetUseLightEffect;
  ...
  public
    property UserVarOptions: TString read GetUserVarOptions write
      SetUserVarOptions;
  end;
  ...
  public
    property FormatTemplate: TString read GetFormatTemplate write
      SetFormatTemplate;
  ...
  public
    property FormatterType
      : TString read GetFormatterType write SetFormatterType;
  ...
  public
    property CountOfDecimals: TString read GetCountOfDecimals write
      SetCountOfDecimals;
    property DecimalSeparatorCharType
      : TString read GetDecimalSeparatorCharType
      write SetDecimalSeparatorCharType;
    property EmptyStringIfZero: TString read GetEmptyStringIfZero write
      SetEmptyStringIfZero;
    property ForceZeroBeforeDecimalSeparator
      : TString read GetForceZeroBeforeDecimalSeparator write
      SetForceZeroBeforeDecimalSeparator;
    property NegativeFormatType: TString read GetNegativeFormatType write
      SetNegativeFormatType;
    property ThousandsSeparatorCharType
      : TString read GetThousandsSeparatorCharType write
      SetThousandsSeparatorCharType;
    property ExponentialFormat: TString read GetExponentialFormat write
      SetExponentialFormat;
    property Units: TString read GetUnits write SetUnits;
    property RemoveTrailingZeroes: TString read GetRemoveTrailingZeroes write
  ...
  private
    ...
    procedure SetExponentialFormat(const value: TString);
  public
    property CurrencySymbol: TString read GetCurrencySymbol write
      SetCurrencySymbol;
    property PositiveFormatType: TString read GetPositiveFormatType write
      SetPositiveFormatType;
    property ExponentialFormat: TString read GetExponentialFormat write
      SetExponentialFormat;
  ...
  public
    ...
    property InputDataType
      : TString read GetInputDataType write SetInputDataType;
    property OmitEmptyParts: TString read GetOmitEmptyParts write
      SetOmitEmptyParts;
  ...
  private
    ...
    procedure SetKeepTogether(const value: TString);
  public
    property AlsoOnEmptyGroup: TString read GetAlsoOnEmptyGroup write
      SetAlsoOnEmptyGroup;
    property KeepTogether: TString read GetKeepTogether write SetKeepTogether;
  end;
  ...
  private
    ...
    procedure SetKeepTogether(const value: TString);
  public
    property ConcatNextDataLine: TString read GetConcatNextDataLine write
      SetConcatNextDataLine;
    property KeepTogether: TString read GetKeepTogether write SetKeepTogether;
  end;
  ...
  public
    property ZebraPattern: TLlDOMPropertyFilling read
      GetLineOtpionDataZebraPattern;
    property ForceSumCalculation: TString read GetForceSumCalculation write
      SetForceSumCalculation;
    property KeepTogether: TString read GetKeepTogether write SetKeepTogether;
  ...
  public
    ...
    property Data: TLlDOMPropertyDataLinesOptionsStaticTable read
      GetLineOptionData;
  ...
  public
    ...
    property GroupHeader: TLlDOMPropertyGroupHeaderLinesOptions read
      GetLineOptionGroupHeader;
    property GroupFooter: TLlDOMPropertyGroupFooterLinesOptions read
      GetLineOptionGroupFooter;
    destructor Destroy; override;
  end;

  TLlDOMTableFieldBase = class(TLlDOMItem)
  private
    fFilling: TLlDOMPropertyChartFilling;
    fFrame: TLlDOMPropertyFrame;
    ...
    function GetDrillDownLinkList: TLlDOMDrillDownLinkList;
  ...
  public
    ...
    property ObjectTypeLLX
      : TString read GetObjectTypeLLX write SetObjectTypeLLX;
    property Width: TString read GetWidth write SetWidth;
    property Wrapping: TLlDOMPropertyFieldWrapping read GetWrapping;
    property DrillDownLinks: TLlDOMDrillDownLinkList read GetDrillDownLinkList;
  ...
  TLlDOMTableFieldText = class(TLlDOMTableFieldBase)
  private
    fAlignmentHorizontal: TLlDOMPropertyAlignmentHorizontal;
    fFont: TLlDOMPropertyFont;
  ...
  public
    ...
    property Contents: TString read GetContents write SetContents;
    property Direction: TString read GetDirection write SetDirection;
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
    ...
    property OptimizeSpaces: TString read GetOptimizeSpaces write
      SetOptimizeSpaces;
    property OutputFormatter: TLlDOMPropertyOutputFormatterBase read
      GetOutputFormatterBase;
    property PlainTextFormat: TString read GetPlainTextFormat write
      SetPlainTextFormat;
  ...
  TLlDOMTableFieldChart = class(TLlDOMTableFieldBase)
  private
  ...
  public
    ...
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
    property Height: TString read GetHeight write SetHeight;
    property SourceTablePath: TString read GetSourceTablePath write
      SetSourceTablePath;
    constructor Create(list: TLlDOMTableLineFieldList); overload;
    destructor Destroy; override;
  end;
  ...
  { PDF }
  TLlDOMTableFieldPDF = class(TLlDOMTableFieldBase)
  private
  ...
  TLlDOMTableFieldGauge = class(TLlDOMTableFieldBase)
  private
  ...
  TLlDOMTableFieldDataGraphic = class(TLlDOMTableFieldBase)
  private
  ...
  TLlDOMTableFieldDrawing = class(TLlDOMTableFieldBase)
  private
    function GetAlignmentVertical: TString;
    procedure SetAlignmentVertical(const value: TString);
    function GetContents: TString;
  ...
  TLlDOMTableFieldRTF = class(TLlDOMTableFieldBase)
  private
    function GetContents: TString;
    procedure SetContents(const value: TString);
    function GetExportAsPicture: TString;
  ...
  TLlDOMTableFieldBarcode = class(TLlDOMTableFieldBase)
  private
    fFont: TLlDOMPropertyFont;
    function GetAlignmentVertical: TString;
    procedure SetAlignmentVertical(const value: TString);
  ...
  public
    ...
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
    property Font: TLlDOMPropertyFont read GetFont;
    property FixedBarOptions: TString read GetFixedBarOptions write
      SetFixedBarOptions;
    property Height: TString read GetHeight write SetHeight;
  ...
  TLlDOMTableFieldDesignerObject = class(TLlDOMTableFieldBase)
  private
    function GetHeight: TString;
    procedure SetHeight(const value: TString);
  public
    ...
    constructor Create(objectName: TString; list: TLlDOMTableLineFieldList);
      overload;
  end;

  TLlDOMTableFieldHTML = class(TLlDOMTableFieldBase)
  private
    function GetContents: TString;
    procedure SetContents(const value: TString);
  ...
  public
    ...
    property Condition: TString read GetCondition write SetCondition;
    property DisplayInDesigner: TString read GetDisplayInDesigner write
      SetDisplayInDesigner;
    property Name: TString read GetName write SetName;
    property Bookmark: TLlDOMPropertyBookmark read GetBookmark;
  ...
  public
    ...
    property RepeatAsHeader: TString read GetRepeatAsHeader write
      SetRepeatAsHeader;
  ...
  public
    property GroupBy: TString read GetGroupBy write SetGroupBy;
    property GroupSums: TString read GetGroupSums write SetGroupSums;
    property TriggerNewPage: TString read GetTriggerNewPage write
      SetTriggerNewPage;
  ...
  public
    ...
    property IssueCondition: TString read GetIssueCondition write
      SetIssueCondition;
  ...
  public
    ...
    property OptimizeSpaces: TString read GetOptimizeSpaces write
      SetOptimizeSpaces;
    property ParagraphSpacing: TString read GetParagraphSpacing write
      SetParagraphSpacing;
  ...
  public
    ...
    property PageBreakCondition: TString read GetPageBreakCondition write
      SetPageBreakCondition;
    ...
    property ShowSeparatorTickmarks
      : TString read GetShowSeparatorTickmarks write
      SetShowSeparatorTickmarks;
    property TableID: TString read GetTableID write SetTableID;
    property SortOrderOD: TString read GetSortOrderID write SetSortOrderID;
  ...
  public
    ...
    property Definition: TLlDOMPropertyChartDefinition read GetDefinition;
    property Height: TString read GetHeight write SetHeight;
    property ReserveSpaceForSubtitle
      : TString read GetReserveSpaceForSubtitle write
      SetReserveSpaceForSubtitle;
  ...
  public
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
    property InputObjectType: TString read GetInputObjectType write
      SetInputObjectType;
  ...
  private
    fFont: TLlDOMPropertyFont;
    fAction: TLlDOMPropertyAction;
    function GetFont: TLlDOMPropertyFont;
    function GetAction: TLlDOMPropertyAction;
    function GetText: TString;
    procedure SetText(const value: TString);
  public
    property Font: TLlDOMPropertyFont read GetFont;
    property Action: TLlDOMPropertyAction read GetAction;
    property Text: TString read GetText write SetText;
  ...
  public
    ...
    property Fileinfo: TLlDOMPropertyFileInfo read GetFileinfo;
    property Isotropic: TString read GetIsotropic write SetIsotropic;
    property ShowOnPreview
      : TString read GetShowOnPreview write SetShowOnPreview;
  ...
  public
    ...
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
    property Frame: TLlDOMPropertyFrame read GetFrame;
    property LineDirection
      : TString read GetLineDirection write SetLineDirection;
    property LineType: TString read GetLineType write SetLineType;
    property Width: TString read GetWidth write SetWidth;
  ...
  public
    ...
    property AllowPageBreak: TString read GetAllowPageBreak write
      SetAllowPageBreak;
    property Direction: TString read GetDirection write SetDirection;
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
  ...
  public
    property FixedBarOptions
      : TLlDOMPropertyFixedBarOptions read GetFixedBarOptions;
    property Font: TLlDOMPropertyFont read GetFont;
    property Frame: TLlDOMPropertyFrame read GetFrame;
  ...
  public
    ...
    property AllowPageBreak: TString read GetAllowPageBreak write
      SetAllowPageBreak;
    property BottomAligned
      : TString read GetBottomAligned write SetBottomAligned;
    property Direction: TString read GetDirection write SetDirection;
    property ExportAsPicture: TString read GetExportAsPicture write
      SetExportAsPicture;
  ...
  public
    property DefaultColumns
      : TLlDOMPropertyDefaultColumns read GetDefaultColumns;
  ...
  public
    property Items[index: integer]
      : TLlDOMTableLineBase read GetItems write SetItems;
  ...
  private
    function GetItems(index: integer): TLlDOMTableFieldBase;
    procedure SetItems(index: integer; const value: TLlDOMTableFieldBase);
    function Add(domObj: TLlDOMTableFieldBase): integer;
    procedure Initialize; override;
  public
    property Items[index: integer]
      : TLlDOMTableFieldBase read GetItems write SetItems; default;
  ...
  private
    function Add(domObj: TLlDOMPropertyCrosstabDimensionSumLabelCell): integer;
    procedure Initialize; override;
  public
    constructor Create(hDomObj: TLlDOMItem);
  ...
  private
    ...
    procedure SetItems(index: integer; const value:
        TLlDOMPropertyCrosstabDimensionSumLabelCell);
  public
    property Items[index: integer]
      : TLlDOMPropertyCrosstabDimensionSumLabelCell read GetItems write SetItems; default;
  ...
  public
    property Items[index: integer]:
      TLlDOMPropertyCrosstabDimensionGroupLabelCell read GetItems write
      SetItems; default;
  ...
  public
    property Items[index: integer]
      : TLlDOMPropertyCrosstabDimensionGrouping read GetItems write
      SetItems; default;
  ...
  public
    property Items[index: integer]
      : TLlDOMPropertyCrosstabCells read GetItems write SetItems;
    default;
  ...
  public
    property Items[index: integer]
      : TLlDOMSubItemBase read GetItems write SetItems; default;
  ...
  public
    property Items[Index: integer]
      : TLlDOMParagraph read GetItems write SetItems; default;
  ...
  public
    property Items[index: integer]
      : TLlDOMPropertyChartConditionalColor read GetItems write SetItems;
    default;
  ...
  public
    property Items[Index: integer]
      : TLlDOMObjectBase read GetItems write SetItems; default;
    property ItemName[Name: TString]
      : TLlDOMObjectBase read GetItemName write SetItemName;
    constructor Create(hDomObj: TLlDOMItem);
    destructor Destroy; override;
    function NewItem(index: integer; ObjectType: TString): TLlDOMItem;
  end;
...
{$IFDEF USELLXOBJECTS}
    fhParentComponent.LlSetOption(53, 0);
{$ENDIF}
    LlProjectClose(fhParentComponent.hLlJob);
    projectLoaded := False;
  end;
end;

constructor TLlDOMProjectBase.Create(hTheParentComponent: TL17_);
begin
  inherited Create();
...
begin
  Close();
  fDomHandle := fhParentComponent.LlDomGetProject();
end;
...
begin
  ...
  if fhParentComponent is TDBL17_ then
    with (fhParentComponent as TDBL17_) do
    begin
      if Assigned(DataSource) then
      begin
        FillTableMapper;
        PassDataStructure(AutoMasterMode, DataSource);
      end;
    end;
...
{$ENDIF}
  result := LlProjectOpen(fhParentComponent.hLlJob, projectType,
    PTChar(projectFile), nOpenMode);
  if result = 0 then
  begin
    result := LlDomGetProject(fhParentComponent.hLlJob, @fDomHandle);
    projectLoaded := True;
  end;
end;
...
begin
  if projectLoaded then
  begin
    LlProjectSave(fhParentComponent.hLlJob, PTChar(projectFile));
  end;
end;
...
begin
  newSumVar := list.NewItem(list.Count);
...
constructor TLlDOMObjectBase.Create(list: TLlDOMObjectList;
  ObjectType: TString; index: integer);
var
  newDomObj: TLlDOMItem;
begin
  inherited Create();
...
function TLlDOMObjectList.NewItem(index: integer;
  ObjectType: TString): TLlDOMItem;
var
  newDomObj: TLlDOMObjectBase;
begin
...
function TLlDOMObjectInputButton.GetAction: TLlDOMPropertyAction;
var
  baseObj: TLlDOMItem;
begin
  if (fAction <> nil) then
  ...
  begin
    ...
    fAction := TLlDOMPropertyAction.Create(baseObj);
    baseObj.Free;
    result := fAction;
  end;
end;
...
function TLlDOMPropertyAction.GetBCC: TString;
begin
  result := GetProperty('SendToBCC');
end;

function TLlDOMPropertyAction.GetBody: TString;
begin
  result := GetProperty('SendToBody');
end;

function TLlDOMPropertyAction.GetCC: TString;
begin
  result := GetProperty('SendToCC');
end;

function TLlDOMPropertyAction.GetFormat: TString;
begin
  result := GetProperty('SendToFormat');
end;

function TLlDOMPropertyAction.GetMailTo: TString;
begin
  result := GetProperty('SendToTo');
end;

function TLlDOMPropertyAction.GetShowDialog: TString;
begin
  result := GetProperty('SendToShowDialog');
end;

function TLlDOMPropertyAction.GetSubject: TString;
begin
  result := GetProperty('SendToSubject');
end;

procedure TLlDOMPropertyAction.SetBCC(const value: TString);
begin
  SetProperty('SendToBCC', value);
end;

procedure TLlDOMPropertyAction.SetBody(const value: TString);
begin
  SetProperty('SendToBody', value);
end;

procedure TLlDOMPropertyAction.SetCC(const value: TString);
begin
  SetProperty('CC', value);
end;

procedure TLlDOMPropertyAction.SetFormat(const value: TString);
begin
  SetProperty('SendToFormat', value);
end;

procedure TLlDOMPropertyAction.SetMailTo(const value: TString);
begin
  SetProperty('SendToTo', value);
end;

procedure TLlDOMPropertyAction.SetShowDialog(const value: TString);
begin
  SetProperty('ShowDialog', value);
end;

procedure TLlDOMPropertyAction.SetSubject(const value: TString);
begin
...
constructor TLlDOMProjectList.Create(hTheParentComponent: TL17_);
begin
...
constructor TLlDOMProjectLabel.Create(hTheParentComponent: TL17_);
begin
...
constructor TLlDOMProjectCard.Create(hTheParentComponent: TL17_);
begin
...
function TLlDOMSubItemBaseList.NewItem(index: integer;
  ObjectType: TString): TLlDOMItem;
var
  newDomObj: TLlDOMSubItemBase;
begin
...
function TLlDOMTableLineFieldList.GetItems(index: integer)
  : TLlDOMTableFieldBase;
begin
  result := TLlDOMTableFieldBase( inherited Items[index]);
end;

procedure TLlDOMTableLineFieldList.SetItems(index: integer;
  const value: TLlDOMTableFieldBase);
begin
  inherited Items[index] := value;
end;

function TLlDOMTableLineFieldList.Add(domObj: TLlDOMTableFieldBase): integer;
begin
  result := inherited Add(domObj);
end;
...
var
  nObjCount: integer;
  baseObj: TLlDOMItem;
  newDomObj: TLlDOMTableFieldBase;
  i: integer;
  ObjectType: TString;
...
function TLlDOMTableLineFieldList.NewItem(index: integer;
  ObjectType: TString): TLlDOMItem;
var
  newDomObj: TLlDOMTableFieldBase;
begin
  newDomObj := TLlDOMTableFieldBase.Create(fDOMObj.CreateSubObject(index,
      ObjectType));
  result := newDomObj;
end;
...
begin
  ...
  begin
    ...
    fPageBreakPreferences := TLlDOMPropertyCrosstabPageBreakPreferences.Create
      (baseObj);
    baseObj.Free;
    result := fPageBreakPreferences;
  end;
...
function TLlDOMCrosstabCellBaseList.Add(domObj:
    TLlDOMPropertyCrosstabDimensionSumLabelCell): integer;
begin
  result := inherited Add(domObj);
end;

procedure TLlDOMCrosstabCellBaseList.Initialize;
var
  nObjCount: integer;
  baseObj: TLlDOMItem;
...
function TLlDOMPropertyCrosstabDimensionGroupLabelCell.GetSortOrderAscending
  : TString;
begin
  result := GetProperty('SortOrderAscending');
end;
...
procedure TLlDOMPropertyCrosstabDimensionGroupLabelCell.SetSortOrderAscending
  (const value: TString);
begin
  SetProperty('SortOrderAscending', value);
end;
...
function TLlDOMCrosstabCellSumLabelList.GetItems(index: integer)
  : TLlDOMPropertyCrosstabDimensionSumLabelCell;
begin
  result := TLlDOMPropertyCrosstabDimensionSumLabelCell
...
function TLlDOMCrosstabCellsList.Add(domObj: TLlDOMPropertyCrosstabCells)
  : integer;
begin
  result := inherited Add(domObj);
end;
...
function TLlDOMSubItemBase.GetBreakBefore: TString;
begin
  result := GetProperty('BreakBefore');
end;

procedure TLlDOMSubItemBase.SetBreakBefore(const value: TString);
begin
  SetProperty('BreakBefore', value);
end;
...
function TLlDOMTableFieldBase.GetCondition: TString;
begin
  result := GetProperty('Condition');
end;

function TLlDOMTableFieldBase.GetDrillDownLinkList: TLlDOMDrillDownLinkList;
begin
...
procedure TLlDOMTableFieldBase.SetCondition(const value: TString);
begin
  SetProperty('Condition', value);
end;

function TLlDOMTableFieldBase.GetFilling: TLlDOMPropertyChartFilling;
var
  baseObj: TLlDOMItem;
begin
  if (fFilling <> nil) then
...
function TLlDOMTableFieldBase.GetFrame: TLlDOMPropertyFrame;
var
  baseObj: TLlDOMItem;
begin
  if (fFrame <> nil) then
...
function TLlDOMTableFieldBase.GetName: TString;
begin
  result := GetProperty('Name');
end;

procedure TLlDOMTableFieldBase.SetName(const value: TString);
begin
  SetProperty('Name', value);
end;

function TLlDOMTableFieldBase.GetWidth: TString;
begin
  result := GetProperty('Width');
end;

function TLlDOMTableFieldBase.GetWrapping: TLlDOMPropertyFieldWrapping;
var
  baseObj: TLlDOMItem;
begin
  if (fWrapping <> nil) then
...
procedure TLlDOMTableFieldBase.SetWidth(const value: TString);
begin
  SetProperty('Width', value);
end;

procedure TLlDOMTableFieldBase.SetObjectType(const value: TString);
begin
  SetProperty('ObjectType', value);
end;

procedure TLlDOMTableFieldBase.SetObjectTypeLLX(const value: TString);
begin
  SetProperty('ObjectTypeLLX', value);
end;

function TLlDOMTableFieldBase.GetObjectType: TString;
begin
  result := GetProperty('ObjectType');
end;

function TLlDOMTableFieldBase.GetObjectTypeLLX: TString;
begin
...
function TLlDOMTableLineData.GetDrillDownLinkList: TLlDOMDrillDownLinkList;
begin
  if fDrillDownLinkList = nil then
  begin
    fDrillDownLinkList := TLlDOMDrillDownLinkList.Create
...
function TLlDOMTableLineBaseList.NewItem(index: integer;
  ObjectType: TString): TLlDOMItem;
var
...
function TLlDOMSignalItemList.AddSignalItem(domObj: TLlDOMPropertySignalItem)
  : integer;
begin
  result := inherited Add(domObj);
end;
...
function TLlDOMPropertyOutputFormatterDouble.GetDecimalSeparatorCharType
  : TString;
begin
...
function TLlDOMPropertyOutputFormatterDouble.GetForceZeroBeforeDecimalSeparator
  : TString;
begin
...
function TLlDOMPropertyOutputFormatterDouble.GetThousandsSeparatorCharType
  : TString;
begin
...
begin
  result := nil;
  if input.ChartType = '0' then // PIE-CHART
  begin
...
class function TLlDOMHelper.SafeFormatterCast
  (input: TLlDOMPropertyOutputFormatterBase)
  : TLlDOMPropertyOutputFormatterBase;
begin
...
class function TLlDOMHelper.SafeValueAxisCast
  (input: TLlDOMPropertyValueAxisBase)
  : TLlDOMPropertyValueAxisBase;
begin
...
function TLlDOMPropertyOutputFormatterPercentage.GetDecimalSeparatorCharType
  : TString;
begin
  result := GetProperty(FormatterType + '.DecimalSeparatorCharType');
end;
...
function TLlDOMPropertyOutputFormatterPercentage.GetThousandsSeparatorCharType
  : TString;
begin
  result := GetProperty(FormatterType + '.ThousandsSeparatorCharType');
end;
...
function TLlDOMPropertyOutputFormatterDegree.GetDecimalSeparatorCharType
  : TString;
begin
  result := GetProperty(FormatterType + '.DecimalSeparatorCharType');
end;
...
function TLlDOMTableLineGroupHeader.GetBreakBefore: TString;
begin
  result := GetProperty('BreakBefore');
end;
...
procedure TLlDOMTableLineGroupHeader.SetBreakBefore(const value: TString);
begin
  SetProperty('BreakBefore', value);
end;
...
procedure TLlDOMObjectPDF.SetExportAsPicture(const value: string);
begin
  SetProperty('ExportAsPicture', value);
end;
...
procedure TLlDOMObjectGauge.SetExportAsPicture(const value: string);
begin
  SetProperty('ExportAsPicture', value);
end;
...
begin
  ...
  begin
    ...
    fCoordinateLabelOthers := TLlDOMPropertyChartLabelCoordinateOthers.Create
      (baseObj);
    baseObj.Free;
    result := fCoordinateLabelOthers;
  end;
...
begin
  ...
  begin
    ...
    fCoordinateLabelOnObject :=
      TLlDOMPropertyChartLabelCoordinateOnObjectPie.Create(baseObj);
    baseObj.Free;
    result := fCoordinateLabelOnObject;
  end;
end;
...
function TLlDOMPropertyChartLabelCoordinateOnObjectPie.GetValue: TString;
begin
  result := GetProperty('Value');
end;
...
procedure TLlDOMPropertyChartLabelCoordinateOnObjectPie.SetValue
  (const value: TString);
begin
  SetProperty('Value', value);
end;
...
function TLlDOMPropertyCategoryAxis.GetChartRowList: TLlDOMChartRowList;
begin
...
function TLlDOMPropertyCategoryAxis.GetCoordinateLabel
...
function TLlDOMPropertyCategoryAxis.GetCoordinateLabelPlacement
  : TLlDOMPropertyCoordinateLabelPlacement;
var
  baseObj: TLlDOMItem;
begin
...
function TLlDOMPropertyCategoryAxis.GetFilter: TString;
begin
  result := GetProperty('Filter');
end;

function TLlDOMPropertyCategoryAxis.GetSamplesForDesigner: TString;
begin
  result := GetProperty('SamplesForDesigner');
end;
...
function TLlDOMPropertyCategoryAxis.GetValue: TString;
begin
  result := GetProperty('Value');
end;

procedure TLlDOMPropertyCategoryAxis.SetFilter(const value: TString);
begin
  SetProperty('Filter', value);
end;

procedure TLlDOMPropertyCategoryAxis.SetSamplesForDesigner
  (const value: TString);
begin
  SetProperty('SamplesForDesigner', value);
end;
...
procedure TLlDOMPropertyCategoryAxis.SetValue(const value: TString);
begin
  SetProperty('Value', value);
end;
...
function TLlDOMPropertyValueAxis.GetVisual: TString;
begin
...
procedure TLlDOMPropertyValueAxis.SetVisual(const value: TString);
begin
  SetProperty('Visual', value);
end;
...
function TLlDOMPropertyChartEngineBar2DStackedRelative.GetUseLightEffect
  : TString;
begin
  result := GetProperty('UseLightEffect');
end;
...
function TLlDOMPropertyChartEngineBar3DStackedRelative.GetUseLightEffect
  : TString;
begin
  result := GetProperty('UseLightEffect');
end;
...
begin
  ...
  begin
    baseObj := GetObject('CoordinateLabelOnObject');
    fCoordinateLabelOnObject :=
      TLlDOMPropertyChartLabelCoordinateOnObject.Create(baseObj);
    baseObj.Free;
    result := fCoordinateLabelOnObject;
  end;
...
function TLlDOMChartRow.GetVisual: TString;
begin
  result := GetProperty('Visual');
end;
...
procedure TLlDOMChartRow.SetVisual(const value: TString);
begin
  SetProperty('Visual', value);
end;
...
var
  ...
  pBuffer: PTChar;
begin
  nSizeReq := LlConvertBLOBToString(_PCUINT8(DevMode), DevMode.dmSize, nil, 0,
    True);
  GetMem(pBuffer, nSizeReq);
  LlConvertBLOBToString(_PCUINT8(DevMode), DevMode.dmSize, pBuffer, nSizeReq,
    True);
...
constructor TLlDOMDrillDownLink.Create(list: TLlDOMDrillDownLinkList);
begin
...
function TLlDOMDrillDownLink.GetMenuText: TString;
begin
...
function TLlDOMDrillDownLink.GetProjectFileName: TString;
begin
...
procedure TLlDOMDrillDownLink.SetMenuText(const value: TString);
begin
...
procedure TLlDOMDrillDownLink.SetProjectFileName(const value: TString);
begin
...
function TLlDOMDrillDownLinkList.Add(domObj: TLlDOMDrillDownLink): integer;
begin
  result := inherited Add(domObj);
end;
...
function TLlDOMDrillDownLinkList.GetItems(index: integer): TLlDOMDrillDownLink;
begin
  result := TLlDOMDrillDownLink( inherited Items[index]);
end;

function TLlDOMDrillDownLinkList.NewItem(index: integer): TLlDOMItem;
var
  newDomObj: TLlDOMDrillDownLink;
begin
  newDomObj := TLlDOMDrillDownLink.Create;
  newDomObj.fDomHandle := fDOMObj.CreateSubObject(Index, 'DrillDownLink');
  Add(newDomObj);
  result := newDomObj;
end;

procedure TLlDOMDrillDownLinkList.SetItems(index: integer;
  const value: TLlDOMDrillDownLink);
begin
  inherited Items[index] := value;
end;
...
begin
  newDomObj := TLlDOMColorRangeItem.Create(fDOMObj.CreateSubObject(index,
      'Item'));
  result := newDomObj;
end;
...
function TLlDOMIconRangeItemList.AddIconRangeItem(domObj: TLlDOMIconRangeItem)
  : integer;
begin
  result := inherited Add(domObj);
end;
...
begin
  newDomObj := TLlDOMIconRangeItem.Create(fDOMObj.CreateSubObject(index,
      'Item'));
  result := newDomObj;
end;
...
function TLlDOMPropertyValueAxisBase.GetValue: TString;
begin
  result := GetProperty('Value');
end;
...
procedure TLlDOMPropertyValueAxisBase.SetValue(const value: TString);
begin
  SetProperty('Value', value);
end;
...
begin
  ...
  begin
    baseObj := GetObject('GetSignalRanges');
