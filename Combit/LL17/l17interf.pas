...
var
	CLSID_LLX:TGUID =                     (D1:$3cbae4e0;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
	IID_LLX_IBASE:TGUID =                 (D1:$3cbae4e1;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
	IID_LLX_IENUMOBJECTS:TGUID =          (D1:$3cbae4e8;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
	IID_LLX_IOBJECT:TGUID =               (D1:$3cbae4e9;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_ILLFONT:TGUID =               (D1:$3cbae4f2;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_ILLCOORDINATEPACKAGE: TGUID = (D1:$3cbae4f0;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_ILLNTFYSINK: TGUID =          (D1:$3cbae4f4;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_ILLAPIWRAPPER:TGUID =         (D1:$3cbae4f3;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_IENUMFUNCTIONS:TGUID=         (D1:$3cbae4e6;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_IFUNCTION:TGUID=              (D1:$3cbae4e7;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
  IID_LLX_ILLAUTORELEASEHANDLE:TGUID=   (D1:$3cbae4f1;D2:$8880;D3:$11d2;D4:($96,$a3,$00,$60,$08,$6f,$ef,$d1));
...
type
  ...
  cmbtHWND  = DWORD;
    ...
    ILlCoordinatePackage = interface(IUnknown)
		function GetOption(const nOption: cardinal; var pv: variant): HResult;  stdcall;
		function RectUnitToSCM(var prc: TRect): HResult;  stdcall;
		function RectSCMToUnit(var prc: TRect): HResult;  stdcall;
		function ScalarUnitToSCM(var pn: cardinal): HResult;  stdcall;
		function ScalarSCMToUnit(var pn: cardinal): HResult;  stdcall;
    end;
    pILlCoordinatePackage = Array[0..0] of ILlCoordinatePackage;

    ILlFont = interface(IUnknown)// defaults to default font when created
		function SetDescr(bDescr: OLEString):HResult;  stdcall;
		function SetDefault: HResult;  stdcall;
		function GetDescr(var pbDescr: OLEString):HResult;  stdcall;
		function GetDefault(var pbIsDefault: boolean):HResult;  stdcall;
		function Edit(hWndParent: cmbtHWND):HResult;  stdcall;
		function Rotate(nAngle: integer):HResult;  stdcall;
		function Scale(dFactor: double):HResult;  stdcall;
		function GetDisplayString(var pbDescr: OLEString):HResult;  stdcall;
		function GetSize: integer;  stdcall;
        function Select(hDC: HDC):HResult;  stdcall;
        function Deselect(hDC: HDC):HResult;  stdcall;
        function Clone(var Obj): HResult;  stdcall;
    end;
    pILlFont = Array[0..0] of ILlFont;

    ILlNtfySink = interface(IUnknown)
		function InvokeHelp(nContextID: cardinal):HResult ;  stdcall;
	end;
    pILlNtfySink = Array[0..0] of ILlNtfySink;
...
begin
    ...
    if m_nIndex <= FObjList.Count-1 then
    	begin
          pObject := TLl17XObject(FObjList[m_nIndex]);
...
begin
    ...
    if m_nIndex <= FFctList.Count-1 then
    	begin
          pFunction := TLl17XFunction(FFctList[m_nIndex]);
