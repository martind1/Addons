...
type
  ...
  TGSInitWithArgs        = function(pinstance:Pgs_main_instance;argc:integer;argv:PPChar):integer; stdcall;
  TGSRunStringBegin      = function(pinstance:Pgs_main_instance;user_errors:integer;pexit_code:Pinteger):integer; stdcall;
  TGSRunStringContinue   = function(pinstance:Pgs_main_instance;str:PChar;len:integer;user_errors:integer;pexit_code:pinteger):integer; stdcall;
  TGSRunStringEnd        = function(pinstance:Pgs_main_instance;user_errors:integer;pexit_code:pinteger):integer; stdcall;
  TGSRunStringWithLength = function(pinstance:Pgs_main_instance;str:PChar;len:integer;user_errors:integer;pexit_code:pinteger):integer; stdcall;
  TGSRunString           = function(pinstance:Pgs_main_instance;str:PChar;user_errors:integer;pexit_code:pinteger):integer; stdcall;
  TGSRunFile             = function(pinstance:Pgs_main_instance;file_name:PChar;user_errors:integer;pexit_code:pinteger):integer; stdcall;
  ...
  //------------------------------------------------------------------------------
  procedure GSAPIError (const ltMessage:string);
  function  GSAPILoadDll(const DllPath: string):HWnd;
  ...
  function  GSAPIInitWithArgs(GSLib:HWnd;pinstance:Pgs_main_instance;argc:integer;argv:PPChar):Integer;
  function  GSAPIRunStringBegin(GSLib:HWnd;pinstance:Pgs_main_instance;user_errors:integer;pexit_code:Pinteger):Integer;
  function  GSAPIRunStringContinue(GSLib:HWnd;pinstance:Pgs_main_instance;str:PChar;len:integer;user_errors:integer;pexit_code:pinteger):Integer;
  function  GSAPIRunStringEnd(GSLib:HWnd;pinstance:Pgs_main_instance;user_errors:integer;pexit_code:Pinteger):Integer;
  function  GSAPIRunStringWithLength(GSLib:HWnd;pinstance:Pgs_main_instance;str:PChar;len:integer;user_errors:integer;pexit_code:pinteger):Integer;
  function  GSAPIRunString(GSLib:HWnd;pinstance:Pgs_main_instance;str:PChar;user_errors:integer;pexit_code:pinteger):Integer;
  function  GSAPIRunFile(GSLib:HWnd;pinstance:Pgs_main_instance;file_name:PChar;user_errors:integer;pexit_code:pinteger):Integer;
