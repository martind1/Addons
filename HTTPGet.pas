...
(*
09.12.11 md  unicode <W>
12.12.11 md  AcceptType: Type war falsch
*)
...
begin
  try
    ...
    AcceptType[0] := PChar(FTAcceptTypes);
    AcceptType[1] := nil;
    ...
    if FTResult or not FTBinaryData then
     begin
      if FTResult then
        FTFileSize := StrToInt(StrPas(PChar(Buf)));
...
procedure Register;
begin
  RegisterComponents('Addons', [THTTPGet]);
end;
