...
//   procedure RowColRegister(ARow, ACol: integer; AComment: TXLSComment);
 ...
 public
   ...
   function AddPicture(Bitmap: {$IFDEF DXE2UP}Vcl.{$ENDIF}Graphics.TBitmap; Transparent: Boolean = false): TXLSPicture; overload;  // -----> GC Add
   function AddPicture(Bitmap: {$IFDEF DXE2UP}Vcl.{$ENDIF}Graphics.TBitmap; TransparentPixel: TPoint): TXLSPicture; overload; // -----> GC Add
...
function TXLSShapes.AddPicture(Bitmap: {$IFDEF DXE2UP}Vcl.{$ENDIF}Graphics.TBitmap; Transparent: Boolean): TXLSPicture;
Var lInterface: TObject;
begin
  Result := nil;
...
function TXLSShapes.AddPicture(Bitmap: {$IFDEF DXE2UP}Vcl.{$ENDIF}Graphics.TBitmap; TransparentPixel: TPoint): TXLSPicture;
begin
